...
- **Wiring is FIXED — reuse v1's pins; ESCALATE before any rewire.** Pump=**BCM26**,
  aux laser/marker=**BCM24** (owner-rewired from v1's BCM27), status LED=**BCM23**, PCA9685=**I2C bus 1 @ 0x40**, 1602A LCD on the
...
- **Use the LCD throughout the lifecycle** (boot+IP, state, target, aim error, kill-zone, fps, shots)
  ...
  BCM24 aux laser is an **opt-in** aim marker (default off — laser safety).
